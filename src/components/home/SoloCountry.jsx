        ...
        <div>
            <div className="card w-full h-[540px] bg-base-100 shadow-xl border-2 border-[#23BE0A] rounded-2xl ">
                <figure className='relative'>
                    ...
                    <h2 className='absolute text-white text-3xl font-bold'>{name}</h2>
                </figure>
                <div className="card-body">
                    <h2 className="card-title"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-[#23BE0A]">
