        ...
        <div>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-3xl font-bold dark:text-white">Explore<p className="text-[#23BE0A]">Asia</p></a>
                </div>
                ...
                <div className="navbar-end space-x-2 flex ">
                    ...
                    <Link to="/login"><button className="btn bg-[#23BE0A] text-white w-20">Login</button></Link>
                    <Link to="/register"><button className="btn bg-[#3dd6e0] text-white w-20">Register</button></Link>
                </div>
            </div>
        </div>
    );
